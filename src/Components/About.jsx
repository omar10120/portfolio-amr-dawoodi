...
function About() {
  ...
  return (
    <>
        <div id='about' className={` container mx-auto  flex items-center justify-center w-full py-5  ${darkMode?'bg-about-body-grey':''} `}><p className={`  rounded-xl p-2 my-10 ${darkMode?'bg-about-grey text-black':'bg-tags w-full text-white'} `}>about me</p> </div>
