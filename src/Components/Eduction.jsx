  ...
  return (
    <>
        <div id='Testimonials' className={`container mx-auto w-full    flex flex-col items-center space-y-12 py-5 text-xl  ${darkMode == 'false'?'bg-about-body-grey':''} `}>
            ...
            {navigation.map((item) => (
                <div className={`w-full flex-col   justify-center py-5  text-center items-center relative  rounded-xl space-y-5 ${darkMode == 'false'?'bg-white':'bg-tags text-white'} `}>
                    ...
                    <div className={`flex  flex-col py-1  } `}>
                        <div className={`flex  justify-center items-center w-full ${darkMode == 'false'?'':''}`}>
