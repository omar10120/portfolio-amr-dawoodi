  ...
  return (
    ...
    <div className={`container mx-auto  flex h-96 max-sm:h-auto  max-sm:flex-col-reverse   ${darkMode ? 'bg-white':'bg-darker text-white'} `}>
        <div className="flex w-2/3  flex-col justify-around max-sm:w-full max-sm:justify-center max-sm:py-5   " >
            ...
            <div className='container mx-auto flex w-full p-0 	'>
                <div className='flex w-32 justify-around  '>
                <svg className={`h-8 w-8 ${darkMode?'text-gray-500':'text-white'} `}  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" /></svg>
                <svg className={`h-8 w-8 ${darkMode?'text-gray-500':'text-white'}`}  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
