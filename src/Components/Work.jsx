...
const navigation = [
    ...
    {name: 'Graphic Desgin Template',freamwork1: 'HTML5',freamwork2: 'CSS', freamwork3: 'Javascript',freamwork4: 'PHP',  src: 'https://i.ibb.co/p36bLFg/image.png', current: false ,hidden:true,  reverse : 'flex-row-reverse',  href : 'https://graphic-and-web-design.vercel.app/', text:'graphic and web design template with 9 sections '},
