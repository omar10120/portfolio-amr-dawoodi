...
const navigation = [
    ...
    {name: 'Mountains View',freamwork1: 'HTML5',freamwork2: 'CSS', freamwork3: 'Javascript',freamwork4: 'PHP',  src: 'https://i.ibb.co/Lxrpmst/image.png', current: false ,hidden:true,  href : 'https://mountains-view.vercel.app/', text:'The portfolio example contains 7 sections , with responsive design and information about me'},
    {name: 'Graphic Desgin Template',freamwork1: 'HTML5',freamwork2: 'CSS', freamwork3: 'Javascript',freamwork4: 'PHP',  src: 'https://i.ibb.co/p36bLFg/image.png', current: false ,hidden:true,  reverse : 'flex-row-reverse',  href : 'https://graphic-and-web-design-emqg0gs8n-omar10120s-projects.vercel.app/', text:'graphic and web design template with 9 sections '},
